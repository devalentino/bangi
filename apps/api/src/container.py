...
container = create_sync_container(
    parameters={
        ...
        'BACKGROUND_SUPERVISOR_POLL_SECONDS': _get_env('BACKGROUND_SUPERVISOR_POLL_SECONDS', float, 0.1),
        ...
        'DISK_UTILIZATION_HISTORY_RETENTION_DAYS': _get_env('DISK_UTILIZATION_HISTORY_RETENTION_DAYS', int, 30),
        'DISK_UTILIZATION_HISTORY_CLEANUP_PERIOD_SECONDS': _get_env(
            'DISK_UTILIZATION_HISTORY_CLEANUP_PERIOD_SECONDS', int, 60 * 60
        ),
    },
    services=[
        database,
