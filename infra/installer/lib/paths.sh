...
BANGI_SHARED_LANDING_RENDERER_DIR="${BANGI_SHARED_DIR}/landing-renderer"
BANGI_SHARED_IP2LOCATION_DIR="${BANGI_SHARED_DIR}/ip2location"
BANGI_SHARED_MODEL2VEC_DIR="${BANGI_SHARED_DIR}/model2vec"
BANGI_SHARED_FIREWALL_DIR="${BANGI_SHARED_DIR}/firewall"
BANGI_IPTABLES_RULES_FILE="${BANGI_SHARED_FIREWALL_DIR}/iptables.rules"
BANGI_OPS_BIN_DIR="${BANGI_ROOT_DIR}/ops/bin"
BANGI_IPTABLES_APPLY_SCRIPT="${BANGI_OPS_BIN_DIR}/apply-iptables"
...
BANGI_ACME_HOME_DIR="${BANGI_ROOT_DIR}/acme"
BANGI_ACME_CHALLENGE_WEBROOT="${BANGI_NGINX_DIR}/acme-challenges"
BANGI_CERTIFICATE_BASE_DIR="${BANGI_NGINX_DIR}/certs"
...
BANGI_SYSTEMD_SERVICE_FILE="/etc/systemd/system/bangi.service"
